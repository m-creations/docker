...
<<<<<<< 07ab3aae68ef52624806070fee67006d1abb2d7b
...
```
docker run -p 8080:8080 -p 50000:50000 -v jenkins_home:/data/jenkins_home jenkins
```

this will automatically create a 'jenkins_home' volume on docker host, that will survive container stop/restart/deletion. 

Avoid using a bind mount from a folder on host into `/var/jenkins_home`, as this might result in file permission issue. If you _really_ need to bind mount jenkins_home, ensure that directory on host is accessible by the jenkins user in container (jenkins user - uid 201) or use `-u some_other_user` parameter with `docker run`.

```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 -v /your/jenkins_home:/data/jenkins_home jenkins
```
